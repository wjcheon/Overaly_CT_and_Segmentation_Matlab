function hOVM = alphamask_three(bwMask, bwMask2, colour, colour2, transparency, axHandle)
...
% v1.0 (Mar 2018) by Wonjoong cheon -- wonjoongcheon@gmail.com 
...
%
rgbI2 = cat(3, colour2(1)*ones(size(bwMask2)), colour2(2)*ones(size(bwMask2)), colour2(3)*ones(size(bwMask2)));
hOVM = imshow(rgbI2, 'Parent', axHandle);
set(hOVM, 'AlphaData', bwMask2*transparency);       % use mask values as alpha channel of overlay
hold off;